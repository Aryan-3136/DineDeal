...
const image = (index: number) => `https://images.unsplash.com/photo-${index}?auto=format&fit=crop&w=900&q=80`;
...
export const restaurants: Restaurant[] = [
...
].map(([slug, name, area, cuisine, cost, rating], index) => ({
  id: `rest-${index + 1}`,
  slug: slug as string,
  name: name as string,
  city: "Mumbai",
  ...
  image_url: image(["1565299624946-b28f40a0ae38", "1555396273-367ea4eb4db5", "1517248135467-4c7edcad34c4", "1540189549336-e6e99c3679fe", "1559339352-11d035aa65de"][index % 5] as unknown as number),
